...
@section('page-title', 'Create Recurring Billing')
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">New Recurring Billing</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('recurring.store') }}" method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" min="1" class="form-control @error('interval') is-invalid @enderror" id="interval" name="interval" value="{{ old('interval', '1') }}" required>
                            <span class="input-group-text" id="interval-label">month(s)</span>
                        </div>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('recurring.index') }}" class="btn btn-secondary me-2">Cancel</a>
                <button type="submit" class="btn btn-primary">Create Recurring Billing</button>
            </div>
        </form>
    </div>
</div>
