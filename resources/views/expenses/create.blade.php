        ...
        <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('reference') is-invalid @enderror" id="reference" name="reference" value="{{ old('reference') }}" placeholder="Receipt, Invoice, or Transaction #">
                    @error('reference')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input @error('is_billable') is-invalid @enderror" type="checkbox" id="is_billable" name="is_billable" value="1" {{ old('is_billable') ? 'checked' : '' }}>
                ...
                <div class="col-md-6">
                    <div class="form-check">
                        <input class="form-check-input @error('is_reimbursable') is-invalid @enderror" type="checkbox" id="is_reimbursable" name="is_reimbursable" value="1" {{ old('is_reimbursable') ? 'checked' : '' }}>
            ...
            <div class="row mb-3 billable-options" style="{{ old('is_billable') ? '' : 'display: none;' }}">
                <div class="col-md-6">
